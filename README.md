...
~~~sh
# getting the code
git clone git@github.com:nko4/the-nic-cages.git && cd ./the-nic-cages/

# developing
npm install
npm start

# deploying (to http://the-nic-cages.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@the-nic-cages.2013.nodeknockout.com
ssh root@the-nic-cages.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@the-nic-cages.2013.nodeknockout.com
ssh -i ./id_deploy root@the-nic-cages.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/the-nic-cages" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
